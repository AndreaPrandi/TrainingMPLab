...
#include "C:\Users\aprandi\MPLABXProjects\Spi_trial.X\mcc_generated_files\delay.h"
#include "C:\Users\aprandi\MPLABXProjects\Spi_trial.X\mcc_generated_files\spi1.h"
...
void SSD1322_HW_SPI_send_byte(uint8_t byte_to_transmit) {
    // Invia il byte utilizzando la funzione SPI1_Exchange8bit, che è una routine bloccante.
    uint8_t received_byte = SPI1_Exchange8bit(byte_to_transmit);

    // Non è necessario attendere il buffer di ricezione, ma leggiamo SPI1BUF per resettare il flag di trasmissione.
